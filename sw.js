...
class he {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), g = h ? await re(
...
const q = "GET", C = (s) => s && typeof s == "object" ? s : { handle: s };
class R {
  /**
...
const Q = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function De(s) {
...
function Le(s) {
  return typeof s == "function" ? Ue(s) : (s instanceof IDBTransaction && Te(s), Ce(s, xe()) ? new Proxy(s, N) : s);
}
function f(s) {
  ...
  if (k.has(s))
    return k.get(s);
  const e = Le(s);
  return e !== s && (k.set(s, e), M.set(e, s)), e;
}
const U = (s) => M.get(s);
...
const Ie = ["get", "getKey", "getAll", "getAllKeys", "count"], Me = ["put", "add", "delete", "clear"], L = /* @__PURE__ */ new Map();
function B(s, e) {
...
class ve {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Pe(Ke, 1, {
...
E(
  ({ url: s }) => s.origin.includes("firestore.googleapis.com"),
  new be({
...
E(
  ({ request: s }) => s.destination === "image" || s.destination === "style" || s.destination === "script",
  new V({
